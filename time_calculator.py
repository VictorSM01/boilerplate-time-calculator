def add_time(start, duration, day=None):
    ...
    This function does not import any Python libraries and assumes that the start times are valid times. The minutes in the duration time will be a whole number less than 60, but the hour can be any whole number.
    ...
    -------
    new_time : str
        time resultang from adding 'duration' to 'start' in the 12-hour clock format.
    ...
    new_time = f'{final_hour}:{final_minutes:02d} {final_meridiem:s}{annotation}'
